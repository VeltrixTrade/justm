  ...
  show() {
    ...
    this.overlayElement.innerHTML = `
      <div class="face-id-wrapper">
        <!-- Face ID Scanner SVG -->
        <svg class="face-id-default" viewBox="0 0 80 80" fill="none">
          <g fill="#FFFFFF">
        ...
        <svg class="face-id-success-svg" viewBox="0 0 80 80">
          <path class="path-tick" stroke="#FFFFFF" stroke-width="5" fill="none" stroke-linecap="round" stroke-linejoin="round" d="M 25,45 35,55 60,30"/>
        </svg>
      </div>
    ...
    // Trigger transition and 3D rotation animation classes smoothly
    const wrapper = this.overlayElement.querySelector('.face-id-wrapper');
    if (wrapper) {
